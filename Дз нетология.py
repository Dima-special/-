...
best_lecturer_2 = Lecturer('Oleg', 'Olegovich')
best_lecturer_2.courses_attached += ['Java']

best_lecturer_3 = Lecturer('Pavel', 'Semenov')
...
student_1 = Student('Dmitriy', 'Dubina')
student_1.courses_in_progress += ['Python']
student_1.finished_courses += ['Python: Расширенный курс']

student_2 = Student('Sigma', 'Sigmovich')
student_2.courses_in_progress += ['Java']
student_2.finished_courses += ['Введение в программирование']

student_3 = Student('Lev', 'Tolstoy')
